    ...
    <footer className="bg-gray-100">
      <div className="mx-auto justify-center text-center  flex flex-col items-center max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="flex items-center">
          ...
          <label className="font-bold text-primary text-[30px]">WELL-Being</label>
        </div>
        <p className="mx-auto mt-2 max-w-md text-center leading-relaxed text-gray-500">
          Empowering Health, Inspiring Hope: Your Partner in Wellness. WELL-Being
          - Where Care Meets Compassion. <br />
         <span className=" font-bold"> "© WELL-Being 2024 </span>. All rights reserved. | We are committed to
