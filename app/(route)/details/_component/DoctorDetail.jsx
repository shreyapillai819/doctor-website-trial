    ...
    <div className="grid grid-cols-1 md:grid-cols-3 border-[1px] p-5 mt-5 rounded-lg">
      ...
      <div>
        <Image
          ...
          height={200}
          alt="doctor"
          className="rounded-lg w-full h-[280px] object-cover md:w-[200px]"
        />
      </div>
      {/* info */}
      <div className='col-span-2 mt-5 flex md:px-10 flex-col gap-3 items-baseline'>
        ...
        <h2
          className="text-[10px] bg-blue-100 p-1 rounded-full px-2 text-primary"
        >
